...
echo "22d873b52f7915afc132c568e61afa00fcec155184361f1dc0a6766ff1ecbcc7 OpenJDK11U-jre_x64_windows_hotspot_${JDK_VER}_${JDK_BUILD}.zip" | sha256sum -c
...
resourcehacker \
    -open native-win64/SanLite.exe \
    -save native-win64/SanLite.exe \
    -action addoverwrite \
